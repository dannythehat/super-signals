...
export function AdminMemberControlsDay35({ apiBaseUrl }: Props) {
  ...
  return <section className="day35-members" aria-labelledby="day35-members-title">
    <div className="workspace-page-header"><div><p className="eyebrow">Owner controls</p><h1 id="day35-members-title">Members &amp; account access</h1><p className="intro">See invited-user trading state, mapped Super Signals exposure and private access. Revocation is a confirmed operational action, not a simple delete.</p></div><span className="workspace-role-pill">OWNER ONLY</span></div>
    ...
    <div className="day35-members-safety"><span aria-hidden="true">◎</span><div><strong>Mapped-only broker safety</strong><small>The close path selects local Super Signals positions with a stored broker position ID. Manual and unmapped MT5 positions are not closure targets.</small></div></div>
  </section>;
}
