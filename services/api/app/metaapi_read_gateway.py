"""Read-only MetaAPI terminal data gateway for Day 23.

This module intentionally exposes only account-state, position and quote reads.
There is no trade/order method here.
"""
