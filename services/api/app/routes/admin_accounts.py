...
def create_trading_admin_setup(
    ...
    raw_token = new_token()
    # The shared recovery table still requires an expires_at value. Trading Admin
    # setup validation deliberately ignores this timestamp and instead remains
    # valid until the token is used or replaced by the Owner.
