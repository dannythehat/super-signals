...
those two dimensions as a Cartesian product creates far too many 0.01 broker positions
on a small paper account. This service uses the minimum deterministic set of atomic
...
layer-management semantics intact while avoiding artificial margin exhaustion.
"""
