...
class CanonicalTelegramPublisherManager(Day34CutoverTelegramPublisherManager):
    ...
    def _website_financial_snapshot(self, session: Any) -> tuple[Any, Decimal, Decimal]:
        """Return the exact live Balance and Today's P&L used by the website."""
    ...
    def _ensure_financial_state(self, session: Any) -> Any:
        """Keep the durable Telegram audit state aligned to the website account-value view."""
    ...
    def _reserve_financial_publication(
        ...
        """Snapshot the exact website Balance and Today's P&L.
    ...
    def _render_live_board(self, rows: list[Any]) -> str:
        ...
        # Use the same same live account-value calculation as the website.
