...
SECTION_DEFINITIONS: tuple[dict[str, Any], ...] = (
    ...
    {
        "key": "user",
        "label": "My approved access",
        "description": "A read-only summary of the trading features available to your account. Use Home and Settings to make changes.",
        "actions": (
            ("account.connect", "MT5 account", "Connect one approved Vantage MT5 account from Settings."),
            ("risk.manage", "Risk setting", "Choose from the approved risk levels in Settings."),
            ("automation.toggle", "Automated trading", "Activate or stop automated trading from Settings."),
            ("signals.view", "Signals", "View approved signals without provider details on Home."),
            ("positions.view", "Positions", "View open and completed positions on Home."),
            ("performance.view", "Performance", "View cash and percentage results on Home."),
            ("passkey.manage", "Passkey", "Device passkey setup will be available here when enabled."),
        ),
    },
)
