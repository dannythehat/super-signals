    ...
    if int(active or 0) > 0:
        bind.execute(
            sa.text(
                ...
                VALUES (
                    'telegram.source_status_change_skipped','source',:source_id,
                ...
                "payload": json.dumps(
                    {
                        ...
                        "open_or_pending_positions": int(active),
                        "reason": "explicit_shadow_waiting_for_existing_position_to_finish",
                    }
                ),
            },
        )
