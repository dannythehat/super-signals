...
class _ExplodingMarginGateway:
    async def calculate_margin(self, **kwargs):
        raise AssertionError("Owner DEMO aggregate margin calculator must not be called")


@pytest.mark.asyncio
async def test_owner_demo_does_not_preblock_large_layer_grid_on_free_margin() -> None:
